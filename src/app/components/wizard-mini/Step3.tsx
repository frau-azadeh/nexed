import { MIniFinalFormValue, MiniFinalSchema } from '@/validation/wizard-mini.final';
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
            ...
            <Button type='submit' variant='primary' loading={isSubmitting}>{isSubmitting ? "در حال ارسال ..." : "ارسال نهایی"}</Button>
        </div>
