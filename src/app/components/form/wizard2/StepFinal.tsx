import { FinalConfirmFormValue, FinalConfirmSchema } from '@/validation/wizard.final.schema';
  ...
  return (
   ...
   >
    <div className='border-b pb-3'>
        ...
        <p className='text-sm text-gray-600'>لطفا اطلاعات خود را بررسی نمایید</p>
    </div>
    ...
    <section>
        ...
        <ul>
            ...
            <li>
             ...
             {s2.gender === "male" && (
            <li>
                <span className='text-gray-500'>وضعیت سربازی 
                    {s2.militaryStatus ==="completed" ? "پایان خدمت"
                    : s2.militaryStatus === "exempted"? "معافیت" 
                    : s2.militaryStatus === "inProgress" ? "در حال انجام" 
                    : "_"    
                    }
                </span>
            </li>
        ...
        <ul className='grid grid-col-1 gap-2 text-sm text-gray-700 md:grid-cols-2'>
            <li>
             ...
             {s3.maritalStatus === "married" &&(
                <li>
                    <span className='text-gray-500'>تعداد فرزند : {s3.childrenCount ?? 0}</span>
                </li>
             )}
        </ul>
    </section>
    ...
    <div className='flex items-center gap-3'>
        ...
        <Button type='submit' loading={isSubmitting}>{isSubmitting ? "در حال ارسال ..." : "ارسال نهایی"}</Button>
    </div>
